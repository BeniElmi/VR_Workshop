...
public:
	...
	UPROPERTY(BlueprintReadWrite, Category = "ProteusAvatar")
		FString RemoteOculusID;

	UPROPERTY(BlueprintReadWrite, Category = "ProteusAvatar")
		AProteusLocal *InProteus;
	...
	UFUNCTION(BlueprintImplementableEvent, Category = ProteusAvatar)
		void StartTick();

	UFUNCTION(BlueprintCallable, Category = "ProteusAvatar")
		void RegisterRemoteAvatar();
